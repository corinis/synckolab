...
function setCardProperty (card, prop, value)
{
	...
	else
	{
		...
		switch (prop)
		{
			case	"AimScreenName":	card.aimScreenName = value; beak;
			case	"AnniversaryDay":	card.anniversaryDay = value; beak;
			case	"AnniversaryMonth":	card.anniversaryMonth = value; beak;
			case	"AnniversaryYear":	card.anniversaryYear = value; beak;
			case	"BirthDay":	card.birthDay = value; beak;
			case	"BirthMonth":	card.birthMonth = value; beak;
			case	"BirthYear":	card.birthYear = value; beak;
			case	"CardType":	card.cardType = value; beak;
			case	"Category":	card.category = value; beak;
			case	"CellularNumber":	card.cellularNumber = value; beak;
			case	"CellularNumberType":	card.cellularNumberType = value; beak;
			case	"Company":	card.company = value; beak;
			case	"Custom1":	card.custom1 = value; beak;
			case	"Custom2":	card.custom2 = value; beak;
			case	"Custom3":	card.custom3 = value; beak;
			case	"Custom4":	card.custom4 = value; beak;
			case	"Department":	card.department = value; beak;
			case	"DisplayName":	card.displayName = value; beak;
			case	"FamilyName":	card.familyName = value; beak;
			case	"FaxNumber":	card.faxNumber = value; beak;
			case	"FaxNumberType":	card.faxNumberType = value; beak;
			case	"FirstName":	card.firstName = value; beak;
			case	"HomeAddress":	card.homeAddress = value; beak;
			case	"HomeAddress2":	card.homeAddress2 = value; beak;
			case	"HomeCity":	card.homeCity = value; beak;
			case	"HomeCountry":	card.homeCountry = value; beak;
			case	"HomePhone":	card.homePhone = value; beak;
			case	"HomePhoneType":	card.homePhoneType = value; beak;
			case	"HomeState":	card.homeState = value; beak;
			case	"HomeZipCode":	card.homeZipCode = value; beak;
			case	"JobTitle":	card.jobTitle = value; beak;
			case	"LastName":	card.lastName = value; beak;
			case	"NickName":	card.nickName = value; beak;
			case	"Notes":	card.notes = value; beak;
			case	"PagerNumber":	card.pagerNumber = value; beak;
			case	"PagerNumberType":	card.pagerNumberType = value; beak;
			case	"PhoneticFirstName":	card.phoneticFirstName = value; beak;
			case	"PhoneticLastName":	card.phoneticLastName = value; beak;
			case	"PreferMailFormat":	card.preferMailFormat =  	value; beak;
			case	"PrimaryEmail":	card.primaryEmail = value; beak;
			case	"SecondEmail":	card.secondEmail = value; beak;
			case	"SpouseName":	card.spouseName = value; beak;
			case	"WebPage1":	card.webPage1 = value; beak;
			case	"WebPage2":	card.webPage2 = value; beak;
			case	"WorkAddress":	card.workAddress = value; beak;
			case	"WorkAddress2":	card.workAddress2 = value; beak;
			case	"WorkCity":	card.workCity = value; beak;
			case	"WorkCountry":	card.workCountry = value; beak;
			case	"WorkPhone":	card.workPhone = value; beak;
			case	"WorkPhoneType":	card.workPhoneType = value; beak;
			case	"WorkState":	card.workState = value; beak;
			case	"WorkZipCode":	card.workZipCode = value; beak;
			case	"AllowRemoteContent":	card.allowRemoteContent =	value; beak;
			default:
				logMessage("Unable to set property: " + prop + " (reason: not found): " + value, LOG_WARNING + LOG_AB);
				return;
		}
		var propName = prop.substring(0,1).toLowerCase() + prop.substring(1);
		eval("card." + propName + " = '" + value + "'");
	}
}